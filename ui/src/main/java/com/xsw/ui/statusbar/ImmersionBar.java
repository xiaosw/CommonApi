...
import com.xsw.ui.R;
import com.xsw.ui.statusbar.listener.OnBarListener;
import com.xsw.ui.statusbar.listener.OnKeyboardListener;
import com.xsw.ui.statusbar.listener.OnNavigationBarListener;

import java.util.HashMap;
import java.util.Map;
import java.util.Set;

import static com.xsw.ui.statusbar.Constants.FLAG_FITS_DEFAULT;
import static com.xsw.ui.statusbar.Constants.FLAG_FITS_STATUS;
import static com.xsw.ui.statusbar.Constants.FLAG_FITS_SYSTEM_WINDOWS;
import static com.xsw.ui.statusbar.Constants.FLAG_FITS_TITLE;
import static com.xsw.ui.statusbar.Constants.FLAG_FITS_TITLE_MARGIN_TOP;
import static com.xsw.ui.statusbar.Constants.IMMERSION_BOUNDARY_COLOR;
import static com.xsw.ui.statusbar.Constants.IMMERSION_ID_NAVIGATION_BAR_VIEW;
import static com.xsw.ui.statusbar.Constants.IMMERSION_ID_STATUS_BAR_VIEW;
import static com.xsw.ui.statusbar.Constants.IMMERSION_MIUI_NAVIGATION_BAR_DARK;
import static com.xsw.ui.statusbar.Constants.IMMERSION_MIUI_STATUS_BAR_DARK;
    ...
    public static void setTitleBar(final Activity activity, int fixHeight, View... view) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            for (final View v : view) {
                ...
                Integer fitsHeight = (Integer) v.getTag(R.id.fits_layout_overlap);
                if (fitsHeight == null) {
                    fitsHeight = 0;
                }
                if (fitsHeight != statusBarHeight) {
                    v.setTag(R.id.fits_layout_overlap, statusBarHeight);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            for (View v : view) {
                ...
                if (fitsHeight != fixHeight) {
                    v.setTag(R.id.fits_layout_overlap, fixHeight);
