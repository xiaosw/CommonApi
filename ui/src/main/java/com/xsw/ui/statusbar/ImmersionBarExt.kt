...
// 初始化ImmersionBar
inline fun Activity.immersionBar(block: ImmersionBar.() -> ImmersionBar) = ImmersionBar.with(this).apply { block(this) }.init()

inline fun Fragment.immersionBar(block: ImmersionBar.() -> ImmersionBar) = ImmersionBar.with(this).apply { block(this) }.init()

inline fun android.app.Fragment.immersionBar(block: ImmersionBar.() -> ImmersionBar) = ImmersionBar.with(this).apply { block(this) }.init()

inline fun DialogFragment.immersionBar(block: ImmersionBar.() -> ImmersionBar) = ImmersionBar.with(this).apply { block(this) }.init()

inline fun android.app.DialogFragment.immersionBar(block: ImmersionBar.() -> ImmersionBar) = ImmersionBar.with(this).apply { block(this) }.init()

inline fun Dialog.immersionBar(activity: Activity, block: ImmersionBar.() -> ImmersionBar) = ImmersionBar.with(activity, this).apply { block(this) }.init()

inline fun Activity.immersionBar(dialog: Dialog, block: ImmersionBar.() -> ImmersionBar) = ImmersionBar.with(this, dialog).apply { block(this) }.init()

inline fun Fragment.immersionBar(dialog: Dialog, block: ImmersionBar.() -> ImmersionBar) = activity?.run { ImmersionBar.with(this, dialog).apply { block(this) }.init() }
        ?: Unit
